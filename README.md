...
Customer information, including location and loyalty points

products.csv

Product information, inventory quantities, and unit prices

invoices.csv

Invoice totals, payment totals, invoice dates, due dates, and payment dates

payments.csv

Individual customer payment transactions

payment_methods.csv

Reference information for available payment methods
